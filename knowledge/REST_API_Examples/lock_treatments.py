...
# a Python object, defines the request headers, and submits the request.
...
for item in responseObj['items']:
    ...
    # Set the accept type for getting the individual treatment definitions.
    ...
    for member in responseBodyJson['members']:
        ...
        requestUrl = baseUrl1 + "/treatmentDefinitions/definitions/" + definitionId
        requestBody, respHeaders = get(requestUrl, accessToken1, acceptType) 
       
        # Create a new version of the treatment definition.
        requestUrl = baseUrl1 + "/treatmentDefinitions/definitions/" \
